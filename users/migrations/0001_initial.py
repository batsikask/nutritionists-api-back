    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ManyToManyField(blank=True, related_name='normal_users', to='users.address')),
                ('contact_info', models.ManyToManyField(blank=True, related_name='normal_users', to='users.contactinfo')),
                ('nutritionists', models.ManyToManyField(blank=True, related_name='client_nutritionists', to='nutritionists.nutritionist')),
